...
export const metadata: Metadata = {
  title: 'Localização Rápida de Pessoas | Precisione',
  description:
    'Identificamos o paradeiro de pessoas para destravar citações e execuções. Relatórios completos, prontos para anexar aos autos, com validação jurídica.',
}
